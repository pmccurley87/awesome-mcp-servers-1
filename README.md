...
- <img src="https://www.finalapproval.ai/favicon.svg" height="14"/> [FinalApproval](https://github.com/finalapproval/final-approval-mcp) - Human-in-the-loop approval gate for AI agents. Your agent calls `submit_approval` before any irreversible action; a human reviews on a branded page; a signed webhook fires back with the decision.
